...
export default function Edit({ template }) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        selectors: {
            row: template.selectors?.row || '',
            title: template.selectors?.title || '',
            deadline: template.selectors?.deadline || '',
            url: template.selectors?.url || '',
            description: template.selectors?.description || '',
            amount: template.selectors?.amount || '',
            location: template.selectors?.location || '',
        },
    });
